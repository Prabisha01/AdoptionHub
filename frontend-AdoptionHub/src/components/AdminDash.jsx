    ...
    <nav className="navbar navbar-expand-lg navbar-light " style={{backgroundColor :'black'}}>
      <div className="container-fluid">
        ...
        <h2 className="nav-item">
              <Link className="nav-link  text-white fs-7  me-5"  to="/admin/dashboard">NursyEase</Link>
            </h2>
        ...
        <div className="collapse navbar-collapse" id="navbarNav">
          <ul className="navbar-nav me-auto">
            ...
            <li className="nav-item">
              <Link className="nav-link text-white fs-5  me-3" to="/admin/notification">Notification</Link>
            </li>
